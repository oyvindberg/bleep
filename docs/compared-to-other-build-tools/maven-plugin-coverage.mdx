...
plugin descriptor) or are concerns better solved by a separate tool.
...
- **19 plugins are built-ins.** Compile, test, package, publish, sign,
...
That accounts for **48 out of 50** by mechanisms that already exist.

The remaining four split into one genuine refusal
