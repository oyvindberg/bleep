...
- [Cross-Building](/docs/concepts/cross-building): one project
  fanned out into multiple variants (Scala 2.13 / 3, JVM / JS /
  Native).
- [Dependencies](/docs/concepts/dependencies): how projects
  depend on Maven artifacts.
- [Scripts and source generation](/docs/concepts/scripts): the
  two ways projects extend the build.
- [Supported test frameworks](/docs/appendix/test-frameworks) , 
