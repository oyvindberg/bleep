...
folder. These are routine refactors in any non-trivial
...
has drifted from canonical form, or wire it into a pre-commit
...
- The schema is closed and exhaustive, every field has a
