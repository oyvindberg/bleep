...
whichever server is selected, with tabs for **Overview** (heap and
live set, GC, threads, CPU, file descriptors), **Workspaces**,
**Activity** (what is compiling, what is queued, who is connected)
and **Config** (what that server booted with).
