...
- [Project layout](/docs/concepts/project-layout): the everyday case.
- [Cross-building](/docs/concepts/cross-building): cross axes
  themselves, beyond just the source layout.
- [Path replacements](/docs/appendix/path-replacements): the full
