...
object GenerateForTapirGrpcExamples extends BleepCodegenScript("GenerateForTapirGrpcExamples") {
  override def run(started: Started, commands: Commands, targets: List[Target], args: List[String]): Unit = {
    ...
    targets.foreach { target =>
      if (Set(s"""|tapir-grpc-examples@jvm212""".stripMargin, s"""|tapir-grpc-examples@jvm213""".stripMargin).contains(target.project.value)) {
        val to = target.sources.resolve(s"""|sttp/tapir/grpc/examples/grpc_simple_books_example/gen/AddBookMsg.scala""".stripMargin)
    ...
    targets.foreach { target =>
      if (Set(s"""|tapir-grpc-examples@jvm212""".stripMargin, s"""|tapir-grpc-examples@jvm213""".stripMargin).contains(target.project.value)) {
        val to = target.sources.resolve(s"""|sttp/tapir/grpc/examples/grpc_simple_books_example/gen/Library.scala""".stripMargin)
        started.logger.withContext("project", target.project.value).warn(s"Writing $to")
        val content = s"""|// Generated by Akka gRPC. DO NOT EDIT.
      |package sttp.tapir.grpc.examples.grpc_simple_books_example.gen
      |
      ...
      |
      |@AkkaGrpcGenerated
      |object Library extends akka.grpc.ServiceDescription {
      |  val name = "Library"
      |
    ...
    targets.foreach { target =>
      if (Set(s"""|tapir-grpc-examples@jvm212""".stripMargin, s"""|tapir-grpc-examples@jvm213""".stripMargin).contains(target.project.value)) {
        val to = target.sources.resolve(s"""|sttp/tapir/grpc/examples/grpc_simple_books_example/gen/LibraryClient.scala""".stripMargin)
        started.logger.withContext("project", target.project.value).warn(s"Writing $to")
        val content = s"""|// Generated by Akka gRPC. DO NOT EDIT.
      |package sttp.tapir.grpc.examples.grpc_simple_books_example.gen
      |
      ...
      |@AkkaGrpcGenerated
      |trait LibraryClient extends Library with LibraryClientPowerApi with AkkaGrpcClient
      |
      |@AkkaGrpcGenerated
      |object LibraryClient {
      |  def apply(settings: GrpcClientSettings)(implicit sys: ClassicActorSystemProvider): LibraryClient =
      |    new DefaultLibraryClient(settings)
      |}
      |
      |@AkkaGrpcGenerated
      |final class DefaultLibraryClient(settings: GrpcClientSettings)(implicit sys: ClassicActorSystemProvider) extends LibraryClient {
      |  import Library.MethodDescriptors._
      |
      |  private implicit val ex: ExecutionContext = sys.classicSystem.dispatcher
      |  private val options = NettyClientUtils.callOptions(settings)
      |  private val clientState = new ClientState(settings, akka.event.Logging(sys.classicSystem, classOf[DefaultLibraryClient]))
      |
      |  
      |  private def addBookRequestBuilder(channel: akka.grpc.internal.InternalChannel) =
      |  
      ...
      |    addBookRequestBuilder(clientState.internalChannel)
      |  
      |
      |  /**
    ...
    targets.foreach { target =>
      if (Set(s"""|tapir-grpc-examples@jvm212""".stripMargin, s"""|tapir-grpc-examples@jvm213""".stripMargin).contains(target.project.value)) {
        val to = target.sources.resolve(s"""|sttp/tapir/grpc/examples/grpc_simple_books_example/gen/LibraryHandler.scala""".stripMargin)
        started.logger.withContext("project", target.project.value).warn(s"Writing $to")
        val content = s"""|// Generated by Akka gRPC. DO NOT EDIT.
      |package sttp.tapir.grpc.examples.grpc_simple_books_example.gen
      |
      ...
      |     *
      |     * Use `akka.grpc.scaladsl.ServiceHandler.concatOrNotFound` with `LibraryHandler.partial` when combining
      |     * several services.
      |     */
      ...
      |          akka.grpc.scaladsl.ServerReflection.partial(List(Library)))
      |
      |
      |    /**
    ...
    targets.foreach { target =>
      if (Set(s"""|tapir-grpc-examples@jvm212""".stripMargin, s"""|tapir-grpc-examples@jvm213""".stripMargin).contains(target.project.value)) {
        val to = target.sources.resolve(s"""|sttp/tapir/grpc/examples/grpc_simple_books_example/gen/SimpleBook.scala""".stripMargin)
        started.logger.withContext("project", target.project.value).warn(s"Writing $to")
        val content = s"""|// Generated by the Scala Plugin for the Protocol Buffer Compiler.
      |// Do not edit!
      |//
    ...
    targets.foreach { target =>
      if (Set(s"""|tapir-grpc-examples@jvm212""".stripMargin, s"""|tapir-grpc-examples@jvm213""".stripMargin).contains(target.project.value)) {
        val to = target.sources.resolve(s"""|sttp/tapir/grpc/examples/grpc_simple_books_example/gen/SimpleBooksExampleProto.scala""".stripMargin)
        started.logger.withContext("project", target.project.value).warn(s"Writing $to")
        val content = s"""|// Generated by the Scala Plugin for the Protocol Buffer Compiler.
      |// Do not edit!
      |//
