...
object GenerateForBloopFrontendTest extends BleepCodegenScript("GenerateForBloopFrontendTest") {
  override def run(started: Started, commands: Commands, targets: List[Target], args: List[String]): Unit = {
    ...
    targets.foreach { target =>
      ...
      |  /** The value is scala.collection.Seq("<COURSIER>/https/repo1.maven.org/maven2/com/github/sbt/junit-interface/0.13.3/junit-interface-0.13.3.jar", "<COURSIER>/https/repo1.maven.org/maven2/junit/junit/4.13.2/junit-4.13.2.jar", "<COURSIER>/https/repo1.maven.org/maven2/org/hamcrest/hamcrest-core/1.3/hamcrest-core-1.3.jar"). */
      |  val junitTestJars: scala.collection.Seq[String] = scala.collection.Seq("<COURSIER>/https/repo1.maven.org/maven2/com/github/sbt/junit-interface/0.13.3/junit-interface-0.13.3.jar", "<COURSIER>/https/repo1.maven.org/maven2/junit/junit/4.13.2/junit-4.13.2.jar", "<COURSIER>/https/repo1.maven.org/maven2/org/hamcrest/hamcrest-core/1.3/hamcrest-core-1.3.jar")
      ...
      |    "junitTestJars: %s, bloopCoursierJson: %s, baseDirectory: %s" format (
      |      junitTestJars, bloopCoursierJson, baseDirectory
      |    )
      |  }
      |}""".stripMargin
