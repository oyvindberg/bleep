...
object GenerateResources extends BleepScript("GenerateResources") {
  def run(started: Started, commands: Commands, args: List[String]): Unit = {
    ...
    Vector(
      ...
      |  /** The value is "1.0-bc06627-20221105T001505Z-SNAPSHOT". */
      |  val version: String = "1.0-bc06627-20221105T001505Z-SNAPSHOT"
      |  /** The value is "2.13.8". */
    ...
    Vector(
      ...
      |/** This object was generated by sbt-buildinfo. */
      |case object BuildInfo {
      |  /** The value is "1.0-bc06627-20221105T001611Z-SNAPSHOT". */
      |  val version: String = "1.0-bc06627-20221105T001611Z-SNAPSHOT"
      |  /** The value is "3.1.1". */
