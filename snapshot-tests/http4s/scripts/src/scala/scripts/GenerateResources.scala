...
object GenerateResources extends BleepScript("GenerateResources") {
  def run(started: Started, commands: Commands, args: List[String]): Unit = {
    ...
    Vector(
      ...
      |/** This object was generated by sbt-buildinfo. */
      |case object BuildInfo {
      |  /** The value is "<BLEEP_GIT>/snapshot-tests-in/http4s/server/js/src/test/resources". */
      |  val test_resourceDirectory = "<BLEEP_GIT>/snapshot-tests-in/http4s/server/js/src/test/resources"
      |  override val toString: String = {
    ...
    Vector(
      ...
      |/** This object was generated by sbt-buildinfo. */
      |case object BuildInfo {
      |  /** The value is "<BLEEP_GIT>/snapshot-tests-in/http4s/server/jvm/src/test/resources". */
      |  val test_resourceDirectory = "<BLEEP_GIT>/snapshot-tests-in/http4s/server/jvm/src/test/resources"
      |  override val toString: String = {
      |    "test_resourceDirectory: %s".format(
      |      test_resourceDirectory
      |    )
