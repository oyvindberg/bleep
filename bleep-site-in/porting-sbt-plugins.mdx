...
This page is for the case where you need functionality that already exists as an sbt plugin and you want to use it from a Bleep [script](/docs/usage/scripts) or [sourcegen script](/docs/usage/sourcegen). If you're writing new functionality from scratch, just write a regular script — no plugin mechanism needed.
