...
Bleep's file format was originally inspired by Bloop's json format,
a very verbose format with everything already resolved.
Bleep adopted the model but makes it much easier to work with.
